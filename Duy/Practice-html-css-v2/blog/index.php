...
<head>
    ...
    <title>Home</title>
    <link rel="icon" href="/Duy/Practice-html-css-v2/img/icon.png" />
    <link rel="stylesheet" href="/Duy/Practice-html-css-v2/css/home.css" />
    <link rel="stylesheet" href="/Duy/Practice-html-css-v2/css/Top_cartegories.css" />
    <link rel="stylesheet" href="/Duy/Practice-html-css-v2/css/Learning_Institution.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Explore_our_popular_course.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Our_online_examination_is _top-notch.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Popular_examination.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\footer.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Competate_with_various_scholars_around_the_globe.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Featured_Competition.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\Get_Publicstions_from_best_Aurtors_around_the_Globe.css" />
    <link rel="stylesheet" href="/Duy\Practice-html-css-v2\css\review.css" />
</head>
<script>
...
<body>
    <header>
        ...
        <form action="/Duy\Practice-html-css-v2\login\login.php" class="form" method="post"><img src="/Duy\Practice-html-css-v2\svg\search.svg"
    ...
    <section class="img_index"><img src="/Duy\Practice-html-css-v2/img/menu_home.png" alt="Menu ảnh" class="img_home" />
    ...
    <div class="support">
        <div class="support_index">
            <div class="live_chat">
                <p>Live chat</p>
                <div class="Remove_Chat"><img src="/Duy\Practice-html-css-v2/img/Remove_Chat.png" alt="" /></div>
            </div>
            <div class="Examination">
                <p>Examination</p>
                <div class="Remove_Examination"><img src="/Duy\Practice-html-css-v2/img/Remove_Examination1.png" alt="" /></div>
            </div>
            <div class="Competition">
                <p>Competition</p>
                <div class="Remove_Competition"><img src="/Duy\Practice-html-css-v2/img/Remove_Competition.png" alt="" /></div>
            </div>
        </div>
        <div class="br_cursor">
            <div class="cursor_black"><a href="#"><img src="/Duy\Practice-html-css-v2/svg/right.svg" alt="" /></a></div>
        </div>
    </div>
    <!--Top cartegories-->
        ...
        <div class="article_background">
            <div class="display_top_caregories">
                <figure class="figure_Top_cartegories"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Top_cartegories\Marketing.png" alt="Marketing" /></div>
                ...
                <figure class="figure_Top_cartegories"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Top_cartegories\Design.jpg" alt="Design" /></div>
                        <figcaption class="fig_Makerting">
                            <h3>Design</h3>
                        </figcaption>
                        <div class="Content_marketing">
                ...
                <figure class="figure_Top_cartegories"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Top_cartegories\Programming.jpg" alt="Programming" /></div>
                        <figcaption class="fig_Makerting">
                            <h3>Programming</h3>
                        </figcaption>
                        <div class="Content_marketing">
                ...
                <figure class="figure_Top_cartegories"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Top_cartegories\Technology.jpg" alt="Technology" /></div>
                        <figcaption class="fig_Makerting">
                            <h3>Technology</h3>
                        </figcaption>
                        <div class="Content_marketing">
            ...
            <div class="inside_background_learning">
                ...
                <div class="background_learning_institution">
                    <div class="circle-container">
                        ...
                        <div class="circle_color"><img src="/Duy\Practice-html-css-v2\Learning_Institution\institution.png"
                                alt="Institution" class="circle-image" /></div>
                    </div>
                    <!--Increase-->
                    <div class="background-outstanding">
                        <div><img src="/Duy\Practice-html-css-v2/img/Remove_Competition.png" alt="Competition"
...
">
                        ...
                        <div class="background_Instructors">
                            <div><img src="/Duy\Practice-html-css-v2\Learning_Institution\Instructors.jpg" alt="Instructors"
        ...
        <div>
            <div class="transform_explore">
                ...
                <div class="transform_sort_by">
                    <div class="sort_by_background">
                        <div class="sort_by_img"><img src="/Duy\Practice-html-css-v2/img/bottom.png" alt="bottom" />
                        </div>
            ...
            <div class="display_figure">
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2/Explore_our_popular_course\Learn_Marketing_from_Top_Instructors..jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
                                <h3>Learn Marketing from Top Instructors</h3>
                            </figcaption>
                            <div class="review_star"><img src="/Duy\Practice-html-css-v2/img/star.png" alt="star" />
                                <p>4.5</p>
                            </div>
                        </div>
                ...
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2\Explore_our_popular_course\Front-end_development.jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
                ...
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2\Explore_our_popular_course\Everrything_you_need_to_know_in_UX.jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
                ...
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2\Explore_our_popular_course\Learn_photography.jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
                ...
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2\Explore_our_popular_course\Be_a_pro_in_data_analysis.jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
                ...
                <figure class="figure_star"><a href="#" class="a_star"><img
                            src="/Duy\Practice-html-css-v2\Explore_our_popular_course\Ethical_Harking.jpg" />
                        <div class="display_star">
                            <figcaption class="ficaption_star">
            ...
            <div class="inside_background">
                ...
                <div class="background_Our_online_examination">
                    <div class="circle-container_our">
                        <div class="circle-border_examination"></div>
                        <div class="circle_color"><img src="/Duy\Practice-html-css-v2\examination\examination.png" alt="Institution"
                                class="circle-image_our" /></div>
                    </div>
                    <!--Increase-->
                    <div class="background-Increase">
                        <div><img src="/Duy\Practice-html-css-v2/img/Increase.png" alt="Competition" class="Competition_outstanding" />
                        </div>
        ...
        <div>
            ...
            <div class="display_Popular_examination">
                <figure class="figure_Popular_examination"><a href="#"><img
                            src="/Duy\Practice-html-css-v2/Popular_examination/NATURE_of_Sciencecbd.png" alt="NATURE_of_Sciencecbd" />
                        <figcaption>NATURE of Science</figcaption>
                    </a></figure>
                <!-- 2022 Astro Report-->
                <figure class="figure_Popular_examination"><a href="#"><img
                            src="/Duy\Practice-html-css-v2/Popular_examination/2022_Astro_Reportpng.png" alt="2022_Astro_Reportpng" />
                        <figcaption>2022 Astro Report</figcaption>
                    </a></figure>
                <!-- Data Analysis With Python -->
                <figure class="figure_Popular_examination"><a href="#"><img
                            src="/Duy\Practice-html-css-v2/Popular_examination/Data_Analysis_With_Python.png"
                            alt="Data_Analysis_With_Python" />
                        <figcaption>Data Analysis With Python</figcaption>
                    </a></figure>
                <!-- Advanced UX Designs -->
                <figure class="figure_Popular_examination"><a href="#"><img
                            src="/Duy\Practice-html-css-v2/Popular_examination/UX_Designs.png" alt="UX_Designs" />
    ...
    <article>
        ...
        <div class="background_Competate_with_various_scholars_around_the_globe">
            <div class="background_Den">
                <div class="circle-container_competate">
                    ...
                    <div class="circle_color_den"></div><img
                        src="/Duy\Practice-html-css-v2\Competate_with_various_scholars_around_the_globe\Den.png" alt="Institution"
            ...
            <div class="background-Competate">
                <div><img src="/Duy\Practice-html-css-v2/img/Remove_Competition.png" alt="Competition" class="Competition_Competate" />
                </div>
    ...
    <article class="article_content_Featured">
        <div>
            ...
            <div class="article_background_Featured">
                ...
                <figure class="figure_Featured"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Top_cartegories\Design.jpg" alt="Design" />
                        </div>
                        <figcaption class="fig_Contest">
                ...
                <figure class="figure_Featured"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2\Featured Competition\Programming_Contest.jpg" alt="Programming" />
                        </div>
                        <figcaption class="fig_Contest">
                ...
                <figure class="figure_Featured"><a href="#">
                        <div><img src="/Duy\Practice-html-css-v2/Top_cartegories\Programming.jpg" alt="Technology" /></div>
                        <figcaption class="fig_Contest">
        ...
        <div class="display_backgound_article">
            <div class="inside_background">
                ...
                <div class="background_Our_online_examination">
                    <div class="circle-container_our">
                        <div class="circle-border_examination"></div>
                        <div class="circle_color"><img src="/Duy\Practice-html-css-v2\Popular_examination\NATURE_of_Sciencecbd.png"
        ...
        <div class="review_article">
            <figure class="review_figure">
                <div class="div_review_father">
                    <div class="div_review"><img src="/Duy\Practice-html-css-v2\review\Mohh_Jumah.jpg" alt="Mohh_Jumah" />
            ...
            <figure class="review_figure">
                <div class="div_review_father">
                    <div class="div_review"><img src="/Duy\Practice-html-css-v2\review\John_Mark.jpg" alt="Mohh_Jumah" />
    ...
    <footer class="footer">
        <div class="display_content_ft">
                ...
                <div class="dislay_ft">
                    <div class="div_footer">
                        ...
                        <div class="fb_tw_ins_in">
                            <div class="fb"><a href="#"><img src="/Duy\Practice-html-css-v2\svg\facebook.svg" alt="facbook" /></a></div>
                            <div class="fb"><a href="#"><img src="/Duy\Practice-html-css-v2\svg\twitter.svg" alt="twitter" /></a></div>
                            <div class="fb"><a href="#"><img src="/Duy\Practice-html-css-v2\svg\instagram.svg" alt="instagram" /></a>
                            </div>
                            <div class="in"><a href="#"><img src="/Duy\Practice-html-css-v2\svg\linkedin.svg" alt="" /></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="display_Contenttionary">
                <div class="Contenttionary"><img src="/Duy\Practice-html-css-v2\img\logo.png" alt="logo" />
                    <p>Contenttionary</p>
                </div>
                <div>
